  ...
  return (
    <div className='max-full mx-auto'>
       ...
       <span className='mb-4 mt-2 ml-2 md:mb-8 md:mt-4 block font-semibold text-sm sm:text-base md:text-lg'>{congratTemplate()}</span>
        ...
        <a  href={window.location.pathname} className='transition duration-75 inline-block font-thin text-base ml-5 mt-24 md:text-lg hover:bg-primaryBlue hover:text-primaryWhite p-2 text-center'>Начать сначала</a>
    </div>
  )
}
